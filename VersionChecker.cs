...
namespace TarkaRadioListenersStats
{
    public static class VersionChecker
    {
        ...
        {
            var c = new WebClient();
            c.Headers.Add("User-Agent", "TarkaRadioListenersStats");
            var s = c.DownloadString("https://api.github.com/repos/JoshuaMaitland/TarkaRadioListenersStats/releases/latest");
